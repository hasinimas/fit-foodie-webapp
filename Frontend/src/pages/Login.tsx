      ...
      <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-emerald-500/10 via-blue-500/10 to-emerald-500/10">
        <div className="w-full max-w-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                ...
                <div className="mt-6">
                  <button type="button" className="w-full flex justify-center items-center py-3.5 border border-gray-300 rounded-xl hover:bg-gray-50 transition-all shadow-sm">
