            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-white border-b border-gray-200">
                  <th className="py-5 px-6 text-left text-gray-900 font-bold">
                    Feature
                  </th>
                  <th className="py-5 px-6 text-center text-gray-900 font-medium">
                    Free
                  </th>
                  <th className="py-5 px-6 text-center text-emerald-600 font-bold">
                    Premium
                  </th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr className="border-b border-gray-200">
                  ...
                  <td className="py-4 px-6 bg-white text-center">Basic</td>
                  <td className="py-4 px-6 bg-white text-center">Advanced</td>
                </tr>
                <tr className="border-b border-gray-200">
                  <td className="py-4 px-6 bg-white text-gray-800 font-medium">
                    Meal Suggestions
                  </td>
                  <td className="py-4 px-6 bg-white text-center">Limited</td>
                  <td className="py-4 px-6 bg-white text-center">Unlimited</td>
                </tr>
                <tr className="border-b border-gray-200">
                  <td className="py-4 px-6 bg-white text-gray-800 font-medium">
                ...
                <tr className="border-b border-gray-200">
                  ...
                  <td className="py-4 px-6 bg-white text-center">—</td>
                  <td className="py-4 px-6 bg-white text-center">1/month</td>
                </tr>
                <tr className="border-b border-gray-200">
                  <td className="py-4 px-6 bg-white text-gray-800 font-medium">
          ...
          <div className="space-y-10">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600">
                ...
                time. If you upgrade, the new features will be immediately
                available. If you downgrade, you'll continue to have access to
                your current plan until the end of your billing cycle.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              <h3 className="text-xl font-bold text-gray-900 mb-3">
              ...
              <p className="text-gray-600">
                Yes, we offer a 14-day free trial of our Premium plan. You won't
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600">
                Premium subscribers get one 30-minute consultation per month
                with a registered dietitian. You can schedule these through the
                app, and they take place via video call.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              <h3 className="text-xl font-bold text-gray-900 mb-3">
              ...
              <p className="text-gray-600">
                ...
                your data in read-only mode. You can export your data at any
                time. If you wish to delete your account completely, you can do
                so from the account settings, and all your data will be
                permanently removed.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Join the thousands of individuals who trust Fit Foodie for their
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 hover:shadow-md transition-all">
              <div className="flex items-center justify-center h-16 mb-6">
                <ShieldIcon size={40} className="text-emerald-500" />
              </div>
              <h3 className="text-xl font-bold text-center text-gray-900 mb-3">
                Secure & Private
              </h3>
              <p className="text-center text-gray-600">
                Your data is encrypted and never shared with third parties. We
                take your privacy seriously.
              </p>
            </div>
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 hover:shadow-md transition-all">
              <div className="flex items-center justify-center h-16 mb-6">
                <CreditCardIcon size={40} className="text-emerald-500" />
              </div>
              <h3 className="text-xl font-bold text-center text-gray-900 mb-3">
                Easy Billing
              </h3>
              <p className="text-center text-gray-600">
                Simple, transparent billing with no hidden fees. Cancel anytime
                with just a few clicks.
              </p>
            </div>
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 hover:shadow-md transition-all">
              <div className="flex items-center justify-center h-16 mb-6">
                <HelpCircleIcon size={40} className="text-emerald-500" />
              </div>
              <h3 className="text-xl font-bold text-center text-gray-900 mb-3">
                24/7 Support
              </h3>
