        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              mission to transform nutritional health.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <p className="text-gray-600 mb-4">
                Help us improve our nutritional AI models and develop new
                features to enhance personalized recommendations.
              </p>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <p className="text-gray-600 mb-4">
                Join our team of nutrition experts to provide guidance and help
                develop our nutritional content.
              </p>
              <Button variant="outline" size="sm">
                View Position
              </Button>
